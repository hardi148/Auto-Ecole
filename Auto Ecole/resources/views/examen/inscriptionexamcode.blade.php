...
<body id="page-top">
  <div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
      ...
      @endif
      <h1>Inscription Examen Code de {{ $detail->nom }} {{ $detail->prenom }} {{ $detail->typepermi }}</h1>
          <form action="{{ url('/ajouterexamencode') }}" method="POST">
              {{ csrf_field() }}
<input type="hidden" name="idetudiant" value="{{ $detail->idetudiant }}">
<input type="hidden" name="idpermi" value="{{ $detail->idpermi }}">
<input type="hidden" name="typeexamen" value="code">
<div class="mb-3">
