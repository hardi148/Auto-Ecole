...
<body id="page-top">
  <div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
      ...
      @endif
          <form action="{{ url('/ajouteretudiant') }}" method="POST">
              {{ csrf_field() }}
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="numtel" value="{{ old('numtel') }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
            
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Adresse:</label>
                  <input type="text" name="adresse" value="{{ old('adresse') }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
               

                <div class="mb-3">
                  <label for="adresseCheckbox" class="form-label">Frais generaux:</label>
                  <input type="checkbox" name="frais" value="1" class="form-check-input" id="adresseCheckbox" aria-describedby="emailHelp">
                </div>
